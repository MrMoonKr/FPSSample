...
public class BuildTools
{
        ...
        BuildOptions opts, string buildId, bool il2cpp)
    {
        ...
        if ( target == BuildTarget.PS4 )
        {
            ...
            {
                EditorUtility.DisplayDialog( "No bundles found", 
                    "No Asset Bundles found. Please build them first",
                    "Ok" );
                return null;
            }
    ...
    public static void BuildLevelBundles( string path, 
                                          BuildTarget target, 
    ...
    public static void Deploy()
    {
        ...
        var deploy              = new ConnectedGames.Build.DeployTools( OnProgressUpdate, 
                                                                        clientApi, 
                                                                        projectId, 
                                                                        orgId, 
                                                                        projectName, 
